...
INTERFACE
  ...
  {„итает три символа, затем присваивает Mo соответствующее значение типа Month, если это не возможно присваивает Mo значение NoMonth}
  PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Month);
  {¬ывести три символа соответствующего значени€ Mo}
IMPLEMENTATION  
  PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month);
  VAR
    Ch1, Ch2, Ch3: CHAR;
